package ru.khtu.platform.common.data.enums;
...
import ru.khtu.platform.common.data.dto.catalog.people.wopeople.WoPeopleDto;
...
import ru.khtu.platform.common.data.entity.catalog.people.wopeople.WoPeopleEntity;
...
import ru.khtu.platform.common.util.mapstruct.catalog.contract.wocontract.WoContractMapperDtoImpl;
import ru.khtu.platform.common.util.mapstruct.catalog.intermediate.wocontractlocations.WoContractLocationsMapperDtoImpl;
import ru.khtu.platform.common.util.mapstruct.catalog.intermediate.wocontracttenant.WoContractTenantMapperDtoImpl;
import ru.khtu.platform.common.util.mapstruct.catalog.organization.organization.OrganizationMapperDtoImpl;
import ru.khtu.platform.common.util.mapstruct.catalog.people.wopeople.WoPeopleMapperDtoImpl;
import ru.khtu.platform.common.util.mapstruct.catalog.classification.classification.ClassificationMapperDtoImpl;
import ru.khtu.platform.common.util.mapstruct.catalog.setup.woportalsettings.WoPortalSettingsMapperDtoImpl;
import ru.khtu.platform.common.util.mapstruct.catalog.space.wospace.WoSpaceMapperDtoImpl;
