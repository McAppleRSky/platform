package ru.khtu.platform.common.data.entity.catalog.people.wopeople;

import lombok.*;
import ru.khtu.platform.statemachine.util.entity.EntityCreateAble;
import ru.khtu.platform.statemachine.util.entity.EntityStateAble;
